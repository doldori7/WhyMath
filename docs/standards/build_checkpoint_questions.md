...
### 현재 상태 스냅샷 (2026-07-13 6회차 갱신 · Phase 1 MVP · 감사: `arch_audit_2026-07-13_r6.md`)
...
| 4 오개념 DB | 839개 카탈로그 + 판정 엔진 (reactive만·preload 0 실측). 탐지 카탈로그 64종·kebab↔M-id crosswalk 라이브 64건(전건 사람 서명·기계 reject-only·적재/노출 플립 전 단계 — 6회차 감사 §3) | 🟢 구현 |
