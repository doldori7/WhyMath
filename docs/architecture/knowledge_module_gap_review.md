...
> ⚠️ **후속 재점검 있음 — `knowledge_module_gap_review_r3.md`(2026-08-11)**. 이 파일은 r1(§1~§4·
> 2026-07-27)과 r2(§5·2026-08-03·in-place 추가)를 담고 있다. 설계 D3·D4·D5는 구현 완료됐고
> (`S4-06`·`ARCH-16`·`ARCH-17`), r2 `KG-01`도 완료됐다. **§1·§5-1의 6칸이 stale**하다 —
> §1 모듈6 "중복 개념 검사 부재"·모듈9 "`constraints` 부재"·모듈10 "영향도·허브·전파 부재"는
> 셋 다 해소됐고, §5-1의 "`/v1/` 13종"은 **19종**, "`learning-path` 도달 0"은 **도달**로 바뀌었다
> (r3 §4가 사유·증거와 함께 정정). 이 파일은 **완료 태스크의 판정 근거 원본**으로 보존하며
> 소급 수정하지 않는다(2026-08-04 헌법 개정). 현행 상태는 r3을 볼 것.
