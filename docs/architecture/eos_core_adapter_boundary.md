...
| `l4` 교수학 | **77 / 14,920** | 2 / 353 | 4 / 588 | — |
| `l5` 상호작용 | 1 / 18 | 9 / 1,605 | — | — |
| `l6` 응용 모드 | **17 / 2,837** | — | — | — |
| `api` | 37 / 15,814 | — | 3 / 462 | — |
| `schema` | 32 / 7,022 | — | 6 / 3,549 | — |
| `db`·`ops`·`privacy`·`harness`·`whs` | — | — | — | 166 / 53,871 |
| **합계** | **300 / 68,502** | **50 / 21,896** | **34 / 8,226** | **172 / 56,811** |
...
| 권고 순서 | ① B분류 3건은 baseline 없이 즉시 해소 가능(`josa.py` 이동) ② C분류 1건은 EOS-66 Protocol로 흡수 ③ A분류 11건만 baseline에 넣고 EOS-66 착지 시 순차 해제 |
