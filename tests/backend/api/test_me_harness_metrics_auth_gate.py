"""`GET /v1/me/harness-metrics` 인가 게이트 회귀 (hermetic) (SEC-13).
...
실려 학생 토큰이 이를 직접 조회할 수 있었다. SEC-13이 `RequireContentAdmin`으로 닫았다.
...
def test_student_role_forbidden(monkeypatch: Any) -> None:
    """SEC-13 핵심 회귀 — `Role.STUDENT` 인증 사용자는 403(원시 지표 도달 불가).
