...
def build_seed() -> tuple[list[str], list[Track], list[Gate], list[Task]]:
    ...
    gates = [
        Gate(
            ...
            kind="human", assignee="kiki", requested="2026-07-05",
            remind_after_days=7,
        ...
        Gate(
            ...
            kind="human", assignee="kiki", requested="2026-07-08",
    ...
    add(Task(
        ...
        track="math-completion", stage="S1", layer="backend", priority=1,
    ...
    add(Task(
        ...
        track="math-completion", stage="S1", layer="backend", priority=1,
        requires_gates=["G-phaiakes9-key"],
        acceptance=["coach 경로가 WH-1 하네스로 단일 수렴 (이중 경로 제거)", "회귀 테스트 green"],
    ))
    add(Task(
    ...
    add(Task(
        ...
        track="math-completion", stage="S1", layer="backend", priority=2,
    ...
    add(Task(
        ...
        track="math-completion", stage="S1", layer="docs", priority=1,
        owner="kiki",
        depends_on=["S1-12-phaiakes9-live-verify"],
    ...
    add(Task(
        ...
        track="math-completion", stage="S2", layer="data-pipeline", priority=1,
        depends_on=["S1-12-phaiakes9-live-verify"],
    ...
    add(Task(
        ...
        track="math-completion", stage="S2", layer="backend", priority=1,
    ...
    add(Task(
        ...
        track="math-completion", stage="S2", layer="backend", priority=2,
        acceptance=["problem_concept 링크가 원자 백본 기준으로 재연결", "마이그레이션 + 테스트"],
        notes="S0에서 S2로 연기된 항목 (ROADMAP S0 절)",
    ))
    add(Task(
        id="S2-04-orphan-129-cleanup",
        title="원자 그래프 orphan 129건 정리",
        track="math-completion", stage="S2", layer="data-pipeline", priority=2,
    ...
    add(Task(
        ...
        track="math-completion", stage="S2", layer="docs", priority=2,
        owner="kiki",
    ...
    add(Task(
        ...
        track="math-completion", stage="S3", layer="docs", priority=1,
        owner="kiki",
    ...
    add(Task(
        ...
        track="math-completion", stage="S4", layer="data-pipeline", priority=1,
    ...
    add(Task(
        ...
        track="math-completion", stage="S5", layer="docs", priority=1,
        owner="kiki",
    ...
    add(Task(
        ...
        track="infra-debt", stage="S1", layer="docs", priority=3, subject="cross",
        acceptance=[
    ...
    add(Task(
        ...
        track="subject-expansion", stage="E1", layer="backend", priority=1,
        subject="physics",
    ...
    add(Task(
        ...
        track="subject-expansion", stage="E1", layer="data-pipeline", priority=1,
        subject="physics",
    ...
    add(Task(
        ...
        track="subject-expansion", stage="E1", layer="data-pipeline", priority=2,
        subject="physics",
    ...
    add(Task(
        ...
        track="subject-expansion", stage="E2", layer="data-pipeline", priority=1,
        subject="chemistry",
        depends_on=[
            "E1-01-dimensional-consistency", "E1-02-problem-subject-area",
            "E1-03-phy-area-registration", "E1-04-physics-misconception-seed",
        ],
    ...
    add(Task(
        ...
        track="subject-expansion", stage="E3", layer="data-pipeline", priority=1,
        subject="biology",
    ...
    add(Task(
        ...
        track="subject-expansion", stage="E4", layer="data-pipeline", priority=1,
        subject="social",
    ...
    add(Task(
        ...
        track="subject-expansion", stage="E5", layer="data-pipeline", priority=1,
        subject="korean",
    ...
    add(Task(
        ...
        track="subject-expansion", stage="E6", layer="data-pipeline", priority=1,
        subject="english",
    ...
    add(Task(
        ...
        track="subject-expansion", stage="E1", layer="docs", priority=3,
        subject="earth-science", owner="kiki",
