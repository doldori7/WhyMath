...
abstract class SceneElement with _$SceneElement {
  const factory SceneElement({
    ...
    // tutoring_prompt (LTHC mastery 적응·S5l)
    /// LTHC 축 역할("entry"/"scaffold"/"extension"·tutoring_prompt kind·판정 아님).
    /// 발화 본문은 위 `promptText`(prompt_text)를 socratic_prompt와 공유 재사용한다.
