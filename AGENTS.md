...
| LLM | 로컬 Ollama(qwen2-math, qwen2.5, qwen3.5:27b, qwen3-vl:8b — 정본 `whymath_backend/l3/router.py` LOCAL_MODEL_MATRIX) · 클라우드 Anthropic(claude-sonnet-4-6 / claude-opus-4-7만 배선됨) |
