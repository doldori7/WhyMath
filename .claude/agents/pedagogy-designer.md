...
> ⚠️ **정본 관계(2026-07-29·PED-11)**: 이 문서는 서브에이전트 *작업 지침*이다 — L4 설계 **정본은 `docs/architecture/04*.md` 계열**이며 충돌 시 정본이 우선한다. 이 문서에만 있는 세부(LTHC 스텁·MetaCoach·질문 카탈로그 등)는 정본 승격 전의 참고 스케치다(정본 이중화 방어 — 04e §9).
