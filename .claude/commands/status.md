...
[진행 중] ▶ <id> [브랜치]  /  (없음)
[차단] ✖ <id> — 사유
[사람 게이트 대기] ⏳ <G-id> [kiki] — N일 경과  ← 오래된 순 (remind_after_days 문턱 도달 — 진짜 지체만)
[예정된 재확인] 🕓 <G-id> [kiki] — 예정 재확인 YYYY-MM-DD (D-n)  ← 문턱 전(2026-08-31 이후: 미래로 못박은 재확인 지점은 지체가 아니라 정상 대기이므로 별도 섹션)
